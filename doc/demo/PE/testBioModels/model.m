function [output] = model(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Akman2008_Circadian_Clock_Model1
% Generated: 03-Jul-2019 17:39:37
% 
% [output] = model() => output = initial conditions in column vector
% [output] = model('states') => output = state names in cell-array
% [output] = model('algebraic') => output = algebraic variable names in cell-array
% [output] = model('parameters') => output = parameter names in cell-array
% [output] = model('parametervalues') => output = parameter values in column vector
% [output] = model('variablenames') => output = variable names in cell-array
% [output] = model('variableformulas') => output = variable formulas in cell-array
% [output] = model(time,statevector) => output = time derivatives in column vector
% 
