function [output] = Model_Example_SBML_odefun(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Model_Example
% Generated: 14-Apr-2021 16:16:48
% 
% [output] = Model_Example_SBML_odefun() => output = initial conditions in column vector
% [output] = Model_Example_SBML_odefun('states') => output = state names in cell-array
% [output] = Model_Example_SBML_odefun('algebraic') => output = algebraic variable names in cell-array
% [output] = Model_Example_SBML_odefun('parameters') => output = parameter names in cell-array
% [output] = Model_Example_SBML_odefun('parametervalues') => output = parameter values in column vector
% [output] = Model_Example_SBML_odefun('variablenames') => output = variable names in cell-array
% [output] = Model_Example_SBML_odefun('variableformulas') => output = variable formulas in cell-array
% [output] = Model_Example_SBML_odefun(time,statevector) => output = time derivatives in column vector
% 
