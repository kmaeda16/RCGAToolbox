...
opts.maxstallgen = 10; % Max Number of Stall Generations for Early Stopping
...
opts.initial_population = 0.4*ones(opts.n_population,problem.n_gene);
% opts.initial_population = 0.4*ones(0.5*round(opts.n_population),problem.n_gene);
% opts.initial_population = rand(opts.n_population,problem.n_gene);
