function [output] = model_odefun(varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Akman2008_Circadian_Clock_Model1
% Generated: 03-Jul-2019 18:07:42
% 
% [output] = model_odefun() => output = initial conditions in column vector
% [output] = model_odefun('states') => output = state names in cell-array
% [output] = model_odefun('algebraic') => output = algebraic variable names in cell-array
% [output] = model_odefun('parameters') => output = parameter names in cell-array
% [output] = model_odefun('parametervalues') => output = parameter values in column vector
% [output] = model_odefun('variablenames') => output = variable names in cell-array
% [output] = model_odefun('variableformulas') => output = variable formulas in cell-array
% [output] = model_odefun(time,statevector) => output = time derivatives in column vector
% 
