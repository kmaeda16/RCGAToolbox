...
% optimizedmodel = REXstarJGG_sbml(model,decodingfun,measurement);
% optimizedmodel = REXstarJGG_sbml(model,decodingfun,measurement,[],[],[],fast_flag,[],[]);
[Results,optimizedmodel] = REXstarJGG_sbml(model,decodingfun,measurement,[],[],[],fast_flag,[],opts);
...
% Results = REXstarJGG_odefun(odefun,icfun,decodingfun,measurement,9,[],[],fast_flag,[],opts);

%% C ODEFUN ver
model = 'hill_c';
% Results = REXstarJGG_c(model,decodingfun,measurement,9,[],[],fast_flag,[],opts);
