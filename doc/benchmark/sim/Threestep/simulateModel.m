...
for i = 1 : N_TRIAL
    tic;
    [ T, Y ] = RCGAsimulate(odefilename,0:120,[],[],0,simopts);
    simtime(i,1) = toc;
    tic;
    [ T, Y ] = RCGAsimulate(odefilename,0:120,[],[],1,simopts);
    simtime(i,2) = toc;
    tic;
    [ T, Y ] = RCGAsimulate(mexfilename,0:120,[],[],2,simopts);
    simtime(i,3) = toc;
end
