% b4_PE               Perform an example of parameter estimation of the  
%                     b4 model, starting from random initial parameters
%
...
% Load the file b4_bounds.mat, containing the following vectors:
...
[fobj_x0,constr_x0,residuals_x0] = b4_obj(x0); 
disp(fobj_x0)
...
% [x,fval] = fmincon(@b4_obj,x0,A,b,Aeq,beq,lb,ub); 
