function plotter(T_sim,Y_sim,T_exp,Y_exp,t_label,y_label,statename)
% plotter plots simulation and experimental data
% 
% [SYNTAX]
% plotter(generation,t_sim,x_sim,t_exp,x_exp,t_label,x_label,statename)
% 
% [INPUT]
