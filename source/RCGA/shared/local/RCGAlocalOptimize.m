...
%                     each row represents an individual. Note that each 
%                     gene should be 0 ~ 1. The first n_population 
%                     individuals of the designated initial population are 
%                     used, and others are ignored. If n < n_population, 
