function RCGAcreateExecutableScript_PE_R2016a(app)
% RCGAcreateExecutableScript_PE_R2016a creates an executable script for 
% parameter estimation using real-coded genetic algorithms (RCGAs). This 
% function must be called by the GUI RCGAToolbox_MissionControl_PE_R2016a.
